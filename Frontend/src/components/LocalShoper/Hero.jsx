  ...
  return (
    <section>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="border-0 shadow rounded-2xl bg-[var(--two5m)]">
              ...
              <DropdownMenuItem className="  ">
                <Button
                  className="cursor-pointer rounded-2xl bg-[var(--two2m)] text-white  hover:bg-green-900"
      ...
      <div className="mt-29 relative">
        ...
        />
        <p className="text-4xl font-bold text-white absolute top-4/4 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black/50 p-2 rounded-lg">
          Local Shop
        </p>
      </div>
    </section>
